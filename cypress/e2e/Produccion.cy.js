...
describe('Ambiente Produccion Fleet Management Availability', () => {
  ...
  it('Fleet Management Availability', () => {
    ...
    cy.get('#j_idt102_4').click()//2025
    cy.log('Selecciona año2025')
    cy.wait(1000)
    cy.log('Selecciona mes Abril')
    cy.xpath('//a[contains(text(),"Jan")]').click()
      .then(capturarTiempoDeCarga)
    cy.wait(1000)
    cy.log('Selecciona mes Marzo')
    cy.xpath('//a[contains(text(),"May")]').click()
      .then(capturarTiempoDeCarga)
    cy.wait(1000)
    cy.log('Selecciona mes Octubre')
    cy.xpath('//a[contains(text(),"Nov")]').click()
      .then(capturarTiempoDeCarga)
    cy.wait(1000)
    cy.log('Selecciona mes Diciembre')
    cy.xpath('//a[contains(text(),"Dec")]').click()
    ...
    cy.wait(1000)
    cy.get('#j_idt102_label').click()
    cy.get('#j_idt102_5').click()//2026
    cy.log('Selecciona año 2026')
    cy.wait(1000)
    cy.log('Selecciona mes Abril')
    cy.xpath('//a[contains(text(),"Feb")]').click()
      .then(capturarTiempoDeCarga)
    cy.wait(1000)
    cy.log('Selecciona mes Marzo')
    cy.xpath('//a[contains(text(),"Aug")]').click()
      .then(capturarTiempoDeCarga)
    cy.wait(1000)
    cy.log('Selecciona mes Octubre')
    cy.xpath('//a[contains(text(),"Jul")]').click()
      .then(capturarTiempoDeCarga)
    cy.wait(1000)
    cy.log('Selecciona mes Diciembre')
    cy.xpath('//a[contains(text(),"Sep")]').click()
      .then(capturarTiempoDeCarga)
    cy.wait(1000)
    cy.get('#table-header > :nth-child(2)').click()
    cy.get('#j_idt56').click()   
